 ...
 */
	...
	/*
	 ...
	 // The directory the application uses to store the Core Data store file. This code uses a directory named "Mane.TrevelApp" in the application's documents Application Support directory.
	 ...
	 let modelURL = NSBundle.mainBundle().URLForResource("TrevelApp", withExtension: "momd")!
